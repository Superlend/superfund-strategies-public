...
import {SuperlendSiloV2StrategyBase} from "./SiloV2StrategyBase.sol";
...
/**
 * @title SuperlendSiloV2Strategy
 * @author Superlend
 * @notice An ERC4626-compliant vault that interfaces with Silo V2 vault.
 *         This contract serves as an adapter between the Silo V2 vault and
 *         the Superlend curated vault on the Silo Earn interface.
 * @dev Implements the ERC4626 standard.
 */
contract SuperlendSiloV2Strategy is
    SuperlendSiloV2StrategyBase,
    Initializable,
    ...
    ERC4626Upgradeable
{
     ...
     * @param silo_ Address of the silo.
     */
    function initialize(
        string memory name_,
        ...
        __SuperlendSiloV2Strategy_init(silo_);
    }

    /**
     * @dev Internal initialization function.
     */
    function __SuperlendSiloV2Strategy_init(
        address silo_
    ) internal onlyInitializing {
        SuperlendSiloV2StrategyStorage
            storage $ = _getSuperlendSiloV2StrategyStorage();
    ...
    function totalAssets() public view override returns (uint256) {
        ...
        return $.silo.maxWithdraw(address(this));
    }
    ...
    function _deposit(
        ...
        IERC20(asset()).approve(address($.silo), assets);
        $.silo.deposit(assets, address(this));
    ...
    function _withdraw(
        ...
        $.silo.withdraw(assets, address(this), address(this));
    ...
    function _maxDeposit() internal view returns (uint256) {
        ...
        return $.silo.maxDeposit(address(this));
    }
}
